...
# Generated by Genus(TM) Synthesis Solution 23.17-s085_1, revision 1.578
# Generated on: Sun May 17 10:34:11 +07 2026 (Sun May 17 03:34:11 UTC 2026)
...
set logfile fv/viterbi_decoder/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/viterbi_decoder -revised fv_map -use_rtl_names
...
set env(RC_VERSION)     "23.17-s085_1"
set env(CDN_SYNTH_ROOT) "/home/cadence/DDIEXPORT23/GENUS231/tools.lnx86"
set CDN_SYNTH_ROOT      "/home/cadence/DDIEXPORT23/GENUS231/tools.lnx86"
set env(CW_DIR) "/home/cadence/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware"
set CW_DIR      "/home/cadence/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /home/cadence/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/home/cadence/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/home/cadence/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/home/cadence/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/home/cadence/DDIEXPORT23/GENUS231/tools.lnx86/lib/chipware/sim"
}
...
read_library -liberty -both \
    /home/iclab6/Desktop/viterbi/synthesis/../lib/sky130_ss_1.62_125_nldm.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../rtl/add_comp_slt.v ../rtl/branch_metric.v ../rtl/control.v ../rtl/extract_bit.v ../rtl/memory.v ../rtl/traceback.v ../rtl/viterbi_decoder.v
elaborate_design -golden -root {viterbi_decoder} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/viterbi_decoder/fv_map.v.gz
elaborate_design -revised -root {viterbi_decoder}
...
set_analyze_option -mapping_file fv/viterbi_decoder/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.viterbi_decoder.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.viterbi_decoder.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.viterbi_decoder.rtl.fv_map.rpt
